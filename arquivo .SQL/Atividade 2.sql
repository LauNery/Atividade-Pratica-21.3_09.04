...
SELECT * FROM tb_dadosProdutos;

INSERT INTO tb_dadosProdutos(cliente, produto, preco, email, telefone, genero, endereco, frete) 
...
SELECT * FROM tb_dadosProdutos WHERE preco > 500.00;

SELECT * FROM tb_dadosProdutos WHERE preco < 500.00;

UPDATE tb_dadosProdutos SET preco = 1000.78 WHERE id = 1;
